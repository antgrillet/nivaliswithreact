...
export default function StoreExperience() {
  return (
    <section className="py-32 bg-gradient-to-b from-amber-50 via-white to-amber-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-amber-100 hover:border-amber-300 relative overflow-hidden h-full">
                  <div className="absolute top-0 right-0 text-amber-200 text-8xl font-serif leading-none opacity-20 group-hover:opacity-30 transition-opacity duration-300">
                    "
                  </div>

                  <div className="flex items-center mb-6 relative z-10">
                    <div className="relative w-16 h-16 rounded-full overflow-hidden mr-4 ring-2 ring-amber-200 group-hover:ring-amber-400 transition-all duration-300">
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-amber-950">{testimonial.name}</h3>
                  ...
                  <p className="text-amber-900/90 leading-relaxed italic relative z-10">
                    "{testimonial.text}"
                  </p>
                </div>
              </motion.div>
