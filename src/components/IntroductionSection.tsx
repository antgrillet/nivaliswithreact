...
export default function IntroductionSection() {
  ...
  return (
    <section className="relative py-20 md:py-40 px-4">
      {/* Image de fond */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/img/acceuil.jpeg"
          alt="Intérieur de la boutique Nivalis aux Gets"
          fill
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold drop-shadow-lg">{content.title}</h2>
            ...
            <motion.address
              ...
              className="bg-white/15 backdrop-blur-md p-5 md:p-8 rounded-2xl border border-white/20 shadow-2xl not-italic"
            >
              <div className="space-y-4 md:space-y-5">
                <div>
                  <p className="font-bold text-amber-300 text-base md:text-lg mb-2 flex items-center">
                  ...
                  <p className="text-white text-sm md:text-base ml-7">{content.hours}</p>
                </div>
                <div>
                  <p className="font-bold text-amber-300 text-base md:text-lg mb-2 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                  ...
                  <p className="text-white text-sm md:text-base ml-7">{content.address}</p>
                </div>
              </div>
            </motion.address>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-2xl border-4 border-white/30 hover:border-white/50 transition-all duration-300"
          >
            <iframe
